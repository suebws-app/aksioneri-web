...
import {
  CalendarExplanationProvider,
  ExplainerSection,
  HowToReadSection,
} from './components/CalendarExplanation';
import type {
  CalendarEvent,
  DirectionOutcome,
  EventDetail,
...
import type { CalendarExplanation } from '@/lib/api/calendar';
...
export interface EventPageProps {
  ...
  slug: string;
  initialExplanation: CalendarExplanation | null;
}
...
export function EventPage({
  ...
  const whyItMattersHeading = t('event.whyItMatters');
  const howToReadHeading = t('event.howToRead');
        ...
        <main id="main-content" className="flex-1">
          ...
          <div className="page-container flex flex-col gap-12 pt-10 lg:flex-row">
            <div className="min-w-0 flex-1 lg:max-w-[780px]">
              <ExplainerSection heading={whyItMattersHeading} />
                  ...
                  >
                    {event.history.entries.map((entry, index) => (
                      <div
                        ...
                        style={{
                          height: `${(entry.value / historyMax) * 100}%`,
                        }}
                      />
                    ))}
                  </div>
              ...
              <HowToReadSection
                heading={howToReadHeading}
                enabled={showHowToRead}
              />
            </div>
